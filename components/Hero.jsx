...
const Hero = () => {
  return (
    <div className="bg-cover h-[calc(100vh-8rem)] md:h-[calc(100vh-5rem)] grid place-items-center relative bg-black">
      ...
      ></video>
      <div className="grid place-items-center text-center max-w-5xl mx-auto text-white z-10 px-4">
        <h1
          className={`${outfit.className} font-semibold text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-tight`}
        >
        ...
        <h5 className="text-lg md:text-xl mt-4">No Heavy Lifting Required!</h5>
